...
const getUserData = async function (req, res) {
  ...
  if (!userDetails)
    return res.send({ status: false, msg: "No such user exists while verifying user details" });
...
// Return a different error message in both these cases
  ...
  if (!user) {
    return res.send("No such user exists while updating");
  }
...
//  ===>  // let userToBeModified = req.params.userId
    ...
    // updatedPosts.user.post.push(message)
